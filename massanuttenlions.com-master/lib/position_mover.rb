...
module PositionMover
  ...
  def move_to_position(new_position)
    ...
    # ensure new_position is an integer in 001..max_position
  ...
  # positions 001-3 under that subject are reordered. The positions
  # of subject2's pages should be unchanged. And each subject
  # should be able to have a page at position 001.
  #
